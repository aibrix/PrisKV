...
void priskv_pin_key(void *_kv, uint8_t *key, uint16_t keylen, uint64_t token, void *_keynode);

void priskv_unpin_key(void *_kv, uint8_t *key, uint16_t keylen, uint64_t token, void *_keynode);
