...
#define PRISKV_DECLARE_STATUS(NAME, CODE, STR, IS_RESP_STATUS) PRISKV_DECLARE_RESP_STATUS_##IS_RESP_STATUS(PRISKV_RESP_STATUS_##NAME, CODE)
#define PRISKV_DECLARE_RESP_STATUS_1(NAME, CODE) NAME = CODE,
